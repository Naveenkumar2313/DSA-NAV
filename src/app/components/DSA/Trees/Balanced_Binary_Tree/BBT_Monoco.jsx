...
import { BBTcodeSnippets } from './BBTcodeSnippets';

const BBT_Monoco = () => {
  const [language, setLanguage] = useState('python');
  const [code, setCode] = useState(BBTcodeSnippets['python']);
  const toastRef = useRef();

  useEffect(() => {
    setCode(BBTcodeSnippets[language]);
  }, [language]);
