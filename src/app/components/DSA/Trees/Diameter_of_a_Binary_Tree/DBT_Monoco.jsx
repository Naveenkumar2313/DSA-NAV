...
import { DBTcodeSnippets } from './DBTcodeSnippets';

const DBT_Monoco = () => {
  const [language, setLanguage] = useState('python');
  const [code, setCode] = useState(DBTcodeSnippets['python']);
  const toastRef = useRef();

  useEffect(() => {
    setCode(DBTcodeSnippets[language]);
  }, [language]);
