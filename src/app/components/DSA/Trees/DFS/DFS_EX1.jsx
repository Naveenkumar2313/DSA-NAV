...
import p5 from "p5";
import { Box, Button, Grid, Paper, Stack, Typography, Tooltip, IconButton } from "@mui/material";
...
const getStyles = (colors, isDark) => ({
  ...
  button: {
    ...
    "&:hover": {
      background: colors.buttons.hoverBg,
    ...
    const sketch = (p) => {
      ...
      const drawNodes = (p) => {
        ...
        for (let node of nodes) {
          ...
          const label =
            node.visitOrder !== null ? `${node.value} (${node.visitOrder})` : node.value;
