  ...
  useLayoutEffect(() => {
    ...
    const sketch = (p) => {
      ...
      const createGraph = (p) => {
        ...
        // Create edges (adjacency list representation)
        // A connects to B, C
        // B connects to A, D, E
        // C connects to A, F
        // D connects to B
        ...
        // F connects to C, E
        edges = [
          new Edge(nodes[0], nodes[1]), // A-B
          new Edge(nodes[0], nodes[2]), // A-C
          new Edge(nodes[1], nodes[0]), // B-A
          new Edge(nodes[1], nodes[3]), // B-D
          new Edge(nodes[1], nodes[4]), // B-E
          new Edge(nodes[2], nodes[0]), // C-A
          new Edge(nodes[2], nodes[5]), // C-F
          new Edge(nodes[3], nodes[1]), // D-B
          new Edge(nodes[4], nodes[1]), // E-B
          new Edge(nodes[4], nodes[5]), // E-F
          new Edge(nodes[5], nodes[2]), // F-C
          new Edge(nodes[5], nodes[4])  // F-E
        ];
      };
