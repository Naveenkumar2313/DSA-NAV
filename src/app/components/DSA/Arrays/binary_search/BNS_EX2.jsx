...
const getExampleColors = (theme) => {
  ...
  return {
    ...
    info: isDark ? "#1a1a1a" : "#e5e7e9", // Not in Range
      ...
      const performStep = () => {
        ...
        if (low <= high) {
          ...
          if (arr[mid] === target) {
            ...
            setStepList((prev) => [
              ...prev,
              `Step ${stepNumber++}: Found ${target} at index ${mid}`
            ]);
            ...
            setStepList((prev) => [
              ...prev,
              `Step ${stepNumber++}: Searching right of index ${mid}`
            ]);
            ...
            setStepList((prev) => [
              ...prev,
              `Step ${stepNumber++}: Searching left of index ${mid}`
            ]);
          ...
          setStepList((prev) => [
            ...prev,
            `Step ${stepNumber++}: ${target} not found in the array`
          ]);
          stateRef.current.searchComplete = true;
          running = false;
          paused = true;
    ...
    >
      ...
      <Grid container spacing={{ xs: 2, md: 4 }} justifyContent="center" alignItems="stretch">
        <Grid item xs={12} md={8}>
          ...
          >
            <Box sx={{ width: "100%", maxWidth: 900, aspectRatio: "20 / 9" }}>
