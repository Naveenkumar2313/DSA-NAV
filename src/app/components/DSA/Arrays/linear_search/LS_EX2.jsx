...
const getExampleColors = (theme) => {
  ...
  return {
    ...
    canvas: {
      ...
      stroke: isDark ? "#4a9eff" : "#2c3e50"
    },
    // Element state colors
    notVisited: isDark ? "#1a1a1a" : "#e5e7e9",
    visited: isDark ? "#5b8fa8" : "#a9cce3",
    current: isDark ? "#f4d35e" : "#f9e79f",
    found: isDark ? "#4ade80" : "#abebc6",
    notFound: isDark ? "#f87171" : "#f5b7b1",
    // Text colors
    text: {
      primary: isDark ? "#e0e0e0" : "#2c3e50",
      secondary: isDark ? "#a0a0a0" : "#7f8c8d"
    },
    // UI colors
    primary: isDark ? "#4a9eff" : "#2c3e50",
