...
import {
  Box, Stack, Typography, IconButton, MenuItem,
  Select, FormControl, InputLabel, Tooltip, useTheme,
} from '@mui/material';
import ContentCopyIcon from '@mui/icons-material/ContentCopy';
import CheckIcon from '@mui/icons-material/Check';
import { NWPcodeSnippets } from './NWPcodeSnippets';
...
const NWP_Monoco = () => {
  ...
  const code = NWPcodeSnippets[lang] || '';
  ...
  return (
    <Box sx={{ p: { xs: 2, sm: 4 } }}>
      <Typography variant="h5" align="center" gutterBottom
        sx={{ color: isDark ? '#f1f5f9' : '#2c3e50', fontWeight: 700 }}>
        Code — Number of Words with Given Prefix (Trie)
      </Typography>
